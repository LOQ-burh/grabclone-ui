...
function FormAskLocation() {
    return ( 
        <div className=" p-5 bg-white absolute top-0 md:top-28 md:max-w-[355px] w-full md:rounded-lg border-[1px]" >
            <h3 className="font-bold mt-40 md:mt-5  text-2xl">
                Good Morning 
            </h3>
            <h1 className="font-bold lg:text-4xl text-2xl">
                Where should we deliver your food today?
            </h1>
            <div className='flex h-fit w-full border-[1px] p-3 rounded-md mt-4'>
